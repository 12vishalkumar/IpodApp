...
// importing song from asserts folder
...
class Ipod extends React.Component{
    ...
    render(){
        return(
            <div style = {styles.ipodContainer} className='iPod-container'>
                ...
                <div id='inner-container' style = {styles.wheel} onMouseOver={this.rotateWheel}>
                    ...
                    <div style = {styles.buttonContainer}>
                        <div style = {styles.middleButtons}>
                            ...
                            <i style = {styles.imageLeftRight} className="fas fa-fast-backward"></i>
                            <div onClick={this.changePage} style={{backgroundImage: 'linear-gradient(45deg, #8c8181, transparent)' , width : '6rem' , height : '6rem' , borderRadius : '50%'}}></div>
                            <i style = {styles.imageLeftRight} className="fas fa-fast-forward"></i>
